function pickRandomColor() {
    ...
    document.getElementById('tBody').insertAdjacentHTML('beforeend', `<div>The color on display is <input type= "text" id="tColor" value=${colorDisplay}><button id="copyCol">Copy</button></div>`);
